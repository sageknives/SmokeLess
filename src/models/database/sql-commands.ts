export class SqlCommands {
  ...
  public static CREATE_SMOKE_TABLE = 'CREATE TABLE IF NOT EXISTS ' + SqlCommands.SMOKE_TABLE_NAME + '(_id INTEGER PRIMARY KEY, entry_time_stamp TEXT, user_id INTEGER)'
  ...
  public static UPDATE_SMOKE_WHERE_ID = 'UPDATE ' + SqlCommands.SMOKE_TABLE_NAME + ' SET entry_time_stamp =?, user_id =? WHERE _id =?';

  //update timestamp by id
  public static UPDATE_SMOKE_ENTRY_TIME_STAMP_WHERE_ID = 'UPDATE ' + SqlCommands.SMOKE_TABLE_NAME + ' SET entry_time_stamp =? WHERE _id =?';
